...
public class DireccionMantenimientoEspecialidadesMedicas {
    ...
    public DireccionMantenimientoEspecialidadesMedicas() {
    }
    ...
    */
     ...
     * @return ArrayList
     */
     public ArrayList<Direccion> listaEspecialidadesMédicas() throws Exception{
      ...
      try {          
            ...
            while(true){
                Direccion direccion = 
                           (Direccion)oLector.readObject();                  
                listaMantenimiento.add(direccion);
            }
